...
## Merge 2 Repositories on Github
...
### ✅ If Error: Correct Remote URL Formats
If you face the error **URL you used to add the remote is malformed**, it means it looks like you're mixing two different URL formats: `git@github.com:` (SSH) and `https://github.com/` (HTTPS).
